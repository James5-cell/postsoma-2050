...
export default function PhilosophyCell() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex flex-1 items-center font-mono text-sm text-green-400 sm:text-base">
        <span>{" > "}</span>
        <span>Ecclesiastes 1:9 God Is Great.</span>
        <span
          className="ml-1 inline-block w-[0.6em] h-[1em] align-middle bg-current animate-blink"
          style={{ color: accent }}
          aria-hidden
        />
      </div>
